...
CREATE TABLE IF NOT EXISTS board_content(
	...
	b_create_date	VARCHAR(125)	DEFAULT CURRENT_TIMESTAMP,
	b_update_date	VARCHAR(125)	DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,		
...
CREATE TABLE IF NOT EXISTS reply(
	...
	r_create_date	VARCHAR(125)	DEFAULT CURRENT_TIMESTAMP,		
	r_update_date	VARCHAR(125)	DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,		
...
CREATE TABLE IF NOT EXISTS attach(
	a_code	VARCHAR(256),
	b_code	VARCHAR(256),
	a_date	VARCHAR(10)	DEFAULT CURRENT_TIMESTAMP,
