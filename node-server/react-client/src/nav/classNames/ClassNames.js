...
export const videoContenView = classNames(
  "absolute flex h-max w-full transition-all duration-700"
);

export const videoBeforeButton = classNames(
  "absolute rounded rounded-full shadow-lg hover:bg-slate-400 hover:text-white top-1/2 z-50 right-2 p-1 cursor-pointer transition-all duration-500"
);
export const videoNextButton = classNames(
  "absolute rounded rounded-full shadow-lg hover:bg-slate-400 hover:text-white top-1/2 z-50 left-2 p-1 cursor-pointer transition-all duration-500"
);
